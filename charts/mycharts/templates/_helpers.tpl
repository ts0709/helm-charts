...
*/}}
{{- define "awanstor-csi.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}


{{- define "awanstor-csi.mount-iscsi" -}}
...
{{- define "awanstor-csi.external-attacher-container" -}}
{{- $ := index . 0 }}
{{- $windows := index . 2 }}
{{- with index . 1 }}
{{- $root := . -}}
...
{{- define "awanstor-csi.external-provisioner-container" -}}
{{- $ := index . 0 }}
{{- $windows := index . 2 }}
{{- with index . 1 }}
{{- $root := . -}}
...
{{- define "awanstor-csi.external-resizer-container" -}}
{{- $ := index . 0 }}
{{- $windows := index . 2 }}
{{- with index . 1 }}
{{- $root := . -}}
...
{{- define "awanstor-csi.external-snapshotter-container" -}}
{{- $ := index . 0 }}
{{- $windows := index . 2 }}
{{- with index . 1 }}
{{- $root := . -}}
...
{{- define "awanstor-csi.external-health-monitor-controller" -}}
{{- $ := index . 0 }}
{{- $windows := index . 2 }}
{{- with index . 1 }}
{{- $root := . -}}
...
{{- define "awanstor-csi.controller-rbac-rules" -}}
